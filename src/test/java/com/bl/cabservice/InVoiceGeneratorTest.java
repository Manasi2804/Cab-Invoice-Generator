...
public class InVoiceGeneratorTest {
    InVoiceGenerator invoiceForNormalPlan = new InVoiceGenerator(InVoiceGenerator.subscriptionPlan.NORMAL);
    InVoiceGenerator invoiceForPremiumPlan = new InVoiceGenerator(InVoiceGenerator.subscriptionPlan.PREMIUM);
